...
public class BallSpawner : MonoBehaviour {
    ...
    public GameObject GetPooledBall()
    {
        ...
        //if we’ve run out of objects in the pool too quickly, create a new one by deactivating the old one.
        if (pooledBalls[ballPoolNum].activeInHierarchy)
        {
            // Deactivate the old version of the ball so it can be reused.
